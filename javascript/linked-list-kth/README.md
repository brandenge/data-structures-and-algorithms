...
- Create a LinkedList class with a `head` property, and `insert`, `includes`, `toString`, `append`, `insertBefore`, `insertAfter`, `delete`, `kthFromEnd`, and `getMiddleNode` methods.
